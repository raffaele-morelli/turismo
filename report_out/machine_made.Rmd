...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, fig.path = "machine_made/")
source('~/R/turismo/machine_made_snow.R')
# rmarkdown::render("machine_made.Rmd")
